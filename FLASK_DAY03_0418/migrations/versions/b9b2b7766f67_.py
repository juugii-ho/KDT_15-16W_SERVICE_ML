...
Revision ID: b9b2b7766f67
Revises: 
Create Date: 2024-04-18 15:32:10.166579
...
def downgrade():
    ...
    sa.Column('content', mysql.VARCHAR(length=10000), nullable=True),
    ...
    sa.Column('vchar_fld', mysql.VARCHAR(length=30), nullable=True),
